function highlightNav() {
  ...
  document.querySelectorAll('.nav-item[data-page], .mob-nav-link[data-page]').forEach(el => {
    ...
    const isActive =
      (page === 'dashboard' && (path === '/' || path.endsWith('index.html'))) ||
  ...
  const drawerHtml = `
    ...
    <div class="mob-nav-drawer" id="mob-nav-drawer">
      ...
      <div class="mob-nav-body">
        ...
        <a href="/pages/pastors.html" class="mob-nav-link" data-page="pastors">
        ...
        <a href="/pages/disciples.html" class="mob-nav-link" data-page="disciples">
        ...
        <a href="/pages/conferences.html" class="mob-nav-link" data-page="conferences">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
          Conferences
        </a>
        <a href="/pages/scanner.html" class="mob-nav-link" data-page="scanner">
        ...
        <a href="/pages/badges.html" class="mob-nav-link" data-page="badges">
        ...
        <a href="/pages/reports.html" class="mob-nav-link" data-page="reports">
