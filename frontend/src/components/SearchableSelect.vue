<template>
  <div class="relative w-full" ref="containerRef">
    <div
      class="flex items-center w-full px-4 py-3 bg-white border border-gray-200/60 rounded-xl text-sm font-semibold transition-all cursor-text focus-within:ring-4 focus-within:ring-indigo-500/10 focus-within:border-indigo-500"
      @click="openDropdown"
    >
      <input
        ref="inputRef"
      ...
      />
      <!-- chevron icon -->
      <svg class="w-4 h-4 text-gray-400 shrink-0 ml-2 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div
      v-if="isOpen"
      class="absolute z-50 w-full mt-2 bg-white border border-gray-100 rounded-xl shadow-2xl max-h-64 overflow-y-auto"
    >
